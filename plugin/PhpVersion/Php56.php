 ...
 */
class Php56 implements PhpVersion, MemoryLimit, PostLimit, UploadFileLimit, DefaultTimezone, MailTarget, DebugImage {

	const PHP_IMAGE = 'ipunktbs/php:5.6-fpm';
	...
	protected function setImage( Service $service ) {
		...
		if ( $this->debug ) {
			$image = $this->debugImageBuilder->makeImage( self::PHP_IMAGE, '2.5.5' );
